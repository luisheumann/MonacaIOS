cordova.define("com.teamnemitoff.phonedialer.phonedialer", function(require, exports, module) { var exec = require('cordova/exec');
...
module.exports = {
    ...
    exit: function(errorCallback, successCallback) {
